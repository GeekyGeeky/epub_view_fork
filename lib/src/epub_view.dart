    ...
    return Column(
      children: <Widget>[
        ...
        Html(
          ...
          customRenders: {
            (c) {
              return c.tree.element?.attributes != null &&
                  c.tree.element!.attributes.containsKey("src");
            }: CustomRender.widget(widget: (ctx, child) {
              final url =
                  ctx.tree.element!.attributes['src']!.replaceAll('../', '');
              return Image(
                image: MemoryImage(
